...
VPX_RC_FIRST_PASS = 1
VP8E_SET_REFERENCE = 1
VP8E_SET_NOISE_SENSITIVITY = 15
VP8E_SET_PREVIEWPP = 3
...
NORMAL_FRAME = 0 # Variable c_int '0'
...
class vpx_codec_cx_pkt(Structure):
    pass
class N16vpx_codec_cx_pkt3DOT_7E(Union):
    pass
class N16vpx_codec_cx_pkt3DOT_73DOT_8E(Structure):
    pass
N16vpx_codec_cx_pkt3DOT_73DOT_8E._fields_ = [
    ('buf', c_void_p),
    ('sz', size_t),
    ('pts', vpx_codec_pts_t),
    ('duration', c_ulong),
...
N16vpx_codec_cx_pkt3DOT_7E._fields_ = [
    ('frame', N16vpx_codec_cx_pkt3DOT_73DOT_8E),
...
vpx_codec_cx_pkt._fields_ = [
    ...
    ('data', N16vpx_codec_cx_pkt3DOT_7E),
]
...
__all__ = ['VPX_RC_ONE_PASS', 'VP8E_SET_FLUSHFLAG', '_ATFILE_SOURCE',
           'vpx_fixed_buf_t', 'int_fast32_t', 'SCNuFAST64', 'SCNdPTR',
           ...
           'VPX_IMG_FMT_UYVY', 'IMG_FMT_UYVY', 'SCNd32', 'PRIX32',
           ...
           'VPX_CODEC_CORRUPT_FRAME', 'vpx_codec_priv_t',
           ...
           'IMG_FMT_PLANAR', 'PRIdPTR', 'vpx_dec_ctx_t',
           'VPX_DL_BEST_QUALITY', 'PRIxFAST32', 'VPX_CODEC_PSNR_PKT',
           'vpx_codec_iface_name', 'VPX_KF_AUTO', 'vpx_active_map_t',
           'vpx_codec_version_extra_str', 'VPX_DEC_OK',
           'IMG_FMT_VPXYV12', 'SCNoLEAST16', 'SCNu64',
           'VP8E_SET_TUNING', '__WORDSIZE',
           'VP8_DECODER_CTRL_ID_START', 'vpx_kf_mode', 'SCNu8',
           '_XOPEN_SOURCE', 'vpx_codec_peek_stream_info',
           'vpx_scaling_mode_t', 'VPX_IMG_FMT_RGB32_LE', '__GLIBC__',
           'SCNdLEAST64', 'SCNu32', 'SCNo64', 'PRIdFAST8',
           ...
           'IMG_FMT_RGB555_LE', 'SCNxFAST64', 'PRIdLEAST64',
           'N16vpx_codec_cx_pkt3DOT_7E', '__USE_ATFILE',
           ...
           'PRIx32', 'PRIiLEAST32', 'VP8E_UPD_ENTROPY',
           ...
           'VPX_VERSION_MAJOR', '__USE_ISOC99', 'PRIoFAST8',
           ...
           'NORMAL_FRAME', 'vpx_codec_set_mem_map', 'IMG_FMT_YUY2',
           ...
           'VP8E_SET_FRAMETYPE', 'vpx_codec_get_global_headers',
           'vpx_codec_enc_config_default', 'VPX_CODEC_MEM_ERROR',
           'VPX_EFLAG_FORCE_KF', 'SCNdFAST32', 'KEY_FRAME',
           '_BSD_SOURCE', 'VPX_CBR', 'vpx_codec_enc_init_ver',
           'VPX_CODEC_CAP_XMA', 'vpx_ref_frame_t',
           'VPX_DEC_INVALID_PARAM', '__GNU_LIBRARY__',
           'vpx_codec_get_stream_info', 'SCNdLEAST16',
           '__USE_LARGEFILE64', 'vpx_codec_get_caps',
           'vpx_codec_decode', 'N16vpx_codec_cx_pkt3DOT_73DOT_8E',
           'SCNo16', 'VPX_IMG_FMT_UV_FLIP', 'VP8E_USE_REFERENCE',
           ...
           'VPX_CODEC_INCAPABLE', '__USE_EXTERN_INLINES',
           ...
           'VP8_NOFILTERING', 'SCNuFAST32', 'VP8E_SET_CPUUSED',
           '__USE_POSIX2', 'vpx_codec_priv', 'uint16_t', 'wcstoumax',
           'vpx_codec_stream_info', 'vpx_codec_vp8_cx_algo',
           'PRIxFAST16', 'vpx_img_alloc', 'int32_t',
           'VP8E_SET_PREVIEWPP', 'vpx_codec_register_put_slice_cb',
           'vp8e_tuning', 'VP8_COMMON_CTRL_ID_MAX', 'SCNuMAX',
           '__USE_MISC', 'SCNiLEAST8', 'vpx_dec_err_t', 'SCNiLEAST32',
           ...
           'VPX_CODEC_MEM_ZERO', 'VP8_EFLAG_NO_UPD_ENTROPY',
           'VP8E_COPY_REFERENCE', 'PRIX16', 'PRIxLEAST32',
           ...
           'VPX_DEC_MEM_ERROR', '_LARGEFILE_SOURCE',
           'VPX_FRAME_IS_KEY', 'PRIoLEAST32', 'uint_least32_t',
           'VPX_CODEC_ABI_MISMATCH', 'vpx_image',
           ...
           'VP8E_FOURFIVE', 'PRIiLEAST16', 'SCNoLEAST32', 'int16_t',
           ...
           'PRIuMAX', 'PRIiMAX', 'PRIuLEAST8', 'vpx_codec_pts_t',
           'SCNi8', 'VP8E_SET_REFERENCE', '__USE_BSD', 'SCNoFAST64',
           ...
           'VP8E_SET_ENCODING_MODE', 'VP8_SET_REFERENCE',
           'SCNoFAST32', 'VPX_IMG_FMT_NONE', 'SCNuLEAST32',
           'vpx_codec_get_frame', 'PRIuLEAST32', 'VPX_IMG_FMT_PLANAR',
           'PRIX8', 'PRIoFAST32', 'PRIoMAX', 'VPX_DEC_CAP_XMA',
           'vpx_img_fmt_t', 'int8_t', 'vpx_rc_mode',
           ...
           'vpx_dec_iter_t', 'SCNxLEAST64', 'SCNx32',
           'VPX_DEC_CAP_PUT_SLICE', 'vpx_codec_get_preview_frame',
           'vpx_codec_ctx', '__wcstoul_internal_defined', '__STRING',
           'int64_t', 'IMG_FMT_VPXI420', '__WCHAR_MIN',
           'uint_fast32_t', 'PRIxLEAST16', '__GNUC_PREREQ',
           'imaxdiv_t', 'VP8E_SET_ARNR_TYPE', 'VP8_TUNE_SSIM',
           'PRId32', 'IMG_FMT_BGR24', 'VPX_CODEC_OK',
           '_LARGEFILE64_SOURCE', 'VP8_SET_DBG_DISPLAY_MV',
           'vpx_psnr_pkt', 'SCNxLEAST16', '__bos0',
           'VP8E_SET_ARNR_MAXFRAMES', 'N13vpx_codec_ctx3DOT_2E',
           'PLANE_PACKED', '_BITS_WCHAR_H', 'VP8E_SET_SHARPNESS',
           'PRIx8', '__GLIBC_MINOR__', 'vp8_postproc_level',
           'VP8D_GET_LAST_REF_UPDATES', 'vpx_active_map', 'offsetof',
           'SCNoPTR', 'PRIdLEAST8']
